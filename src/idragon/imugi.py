...
class IdfObjectLinkedDataFrame(pd.DataFrame):
    ...
    * Values are not continuously synchronized; they are synchronized when exiting the context manager
    ...
    def __enter__(self) -> IdfObjectLinkedDataFrame:
        ...
        Returns
        -------
            IdfObjectLinkedDataFrame: linked DataFrame
        """
        return self
    ...
    def __exit__(self,
        ...
        * Raised exceptions are propagated
...
class StaticIndexedDict(UserDict):
    ...
    * prevent insertion of unsupported keys
...
def _format_memo(
    ...
    Examples
    --------
        >>> original_text = "This object does not come from a user input.  This is generated by a pre-processor so that various conditions can be gracefully passed on by the InputProcessor. Actually introduced in V1.2.3 "
        >>> formatted_text = _format_memo(original_text)
        >>> print(formatted_text)
        - This object does not come from a user input.
        - This is generated by a pre-processor so that various conditions can be gracefully passed on by the InputProcessor.
...
class IddField():
    ...
    def __init__(self,
        *,
        ...
        - All attributes must be specified as keyword arguments
        """
    ...
    def _parse_attributes(text:str) -> dict:
        ...
        # define empty attribute dictionary
        attr_dict = {
            "memo": "",
            "key" :[] ,
            "reference"    : [],
    ...
    def __eq__(self, other:"IddField") -> bool:
        ...
        if not isinstance(other, IddField):
            raise TypeError(
                f"Cannot compare IddField instance with {type(other)}."
            )
...
class IddObject(StaticIndexedDict):
    ...
    def __init__(self,
        *args: tuple[IddField],
        ...
        - All additional attributes must be specified as keyword arguments
    ...
    def _parse_attributes(text:str) -> dict:
        ...
        for attr in attributes:
            ...
            # define attribute dictionary by flags
            # note 1. 'extensible' requires parsing the size of the extensible field set <#>,
    ...
    """immutable initially processed attributes
    """
    ...
    def __eq__(self, other:"IddObject") -> bool:
        ...
        if not isinstance(other, IddObject):
            raise TypeError(
                f"Cannot compare IddObject instance with {type(other)}."
            )
...
class IDD(StaticIndexedDict):
    ...
    # prevent repeated loading of the same idd pickles
    loaded = dict()
    ...
    def _read_iddfile_anyway(filepath:str) -> str:
        """ read idd file with various encodings
        * encoding candidates are: UTF-8, ASCII, WINDOWS-1252
        * see the issue: https://github.com/NREL/EnergyPlus/issues/10365
        ...
        raise RuntimeError(
            f"None of the encodings in {encoding_candidates}\n",
            f"can read the file {filepath}"
        )
    ...
    def _parse_energyplus_version(text:str) -> Version:
        ...
        if not ep_version_match:
            raise VersionIdentificationError(
                f"Cannot find EnergyPlus version as the format 'IDD_Version x.x.x' in the idd text"
            )
    ...
    def _clean_iddtext(text:str) -> str:
        """ Clean IDD text to parse objects, fields, etc.
        * remove comments
    ...
    def read_idd(cls,
        ...
        *,
        ...
        ----
            filepath (str)           : idd file path
            verbose  (bool, optional): show progress while parsing IDD objects if True. Default to False.
        """
    ...
    """immutable initially processes properties
    """
    ...
    def __eq__(self, other:"IDD") -> bool:
        ...
        if not isinstance(other, IDD):
            raise TypeError(
                f"Cannot compare IDD instance with {type(other)}."
            )
    ...
    def to_pickle(self,
        ...
        # file name of the IDD instance refers to the property of 'Version' class
...
class IdfObject(StaticIndexedDict):
    ...
    def __init__(self,
        ...
        *,
        ...
        ----
            ...
            ignore_default (bool): do not use default values. only use user-provided items
        ...
        * the number of values does not need to match the maximum number of fields
    ...
    def __init__(self,
        *args,    
        ...
        # initialize data dictionary with keys specified by idd
        ...
        match self.idd[key].type:
            ...
            case "integer":
                ...
                if isinstance(value, str):
                    ...
                    # temporarily convert to float (then it will be converted into integer at the next step)
                    if re.match(numeric_pattern, value):
                        value = float(value)
                    
                    # else if it is 'autosize' or 'autocalculate', normalize the value to lowercase for consistency
    ...
    def __deepcopy__(self, memo:dict):
        """ deep-copied instance has no parent, but shares idd and deep-copied values
        """
    ...
    def check_validity(self) -> bool:
        ...
        # do nothing for non-validity checking instance
    ...
    def choices(self, key) -> list|None:
        ...
        Returns
        -------
            list[str]: available keys for the field,
        ...
        # if referenced
            ...
            for obj_list in self.idd[key].object_list:
                ...
                # Case 2: 'reference-class-name' of an object
    ...
    def check_field_validity(
        ...
        """ check validity of a single field instance with corresponding idd

        Args
        ----
            value  (int|float|str) : field value
        ...
        match idd.type:
            ...
            case "real":
                ...
                if not isinstance(value, int|float):
                    raise InvalidFieldValue(
                        f"The value '{value}' for field '{idd.name}' in '{idd.name}' must be a real number."
                    )
            ...
            case "choice":
                # the value must be one of the allowed keys
    ...
    * convertible to dataframe
    ...
    def _index_transformer(self, index:int|str|re.Pattern|Callable) -> int|list[bool]:
        ...
        * str or pattern types require 'Name' field for the instance
        ...
        Args
        ----
            index (int)       : an integer. It will be returned as itself
            index (str)       : a string. must be a member of the 'Name's
    ...
    def __setitem__(self, index:int, value:IdfObject|Iterable|dict):
        ...
        # allocate value and set a new parent
    ...
    def to_dataframe(self) -> pd.DataFrame:
        """ construct a dataframe with field values
        """
    ...
    def as_dataframe(self) -> IdfObjectLinkedDataFrame:
        ...
        * refers to the docstring of 'IdfObjectLinkedDataFrame'
    ...
    def append(self, value:IdfObject) -> None:
        ...
        * must share the same IDD with the current idf_object_list
    ...
    def append(self, value:Iterable) -> None:
        ...
        * such as IdfObjectList, list of OtherClass, ...
        ...
        Args
        ----
            value (Iterable): items used to initialize an IdfObject
    ...
    def append(self, value_dict:dict) -> None:
        ...
        * 'key'(s) must be proper for the idd
        ...
        Args
        ----
            value_dict (dict): dictionary used to initialize an IdfObject
    ...
    def insert(self,
        ...
        **kwargs
        ...
        if self.idd.is_unique and (len(self) > 0) and self.ensure_validity:
            raise ValueError(
                f"Cannot append (or insert) a new idfobject '{self.idd.name}' because the object type is unique and an instance already exists"
            )
    ...
    def __eq__(self, other:IdfObjectList) -> bool:
        ...
        # if the two lists have different lengths: False
...
class IDF(StaticIndexedDict):
    ...
    def __init__(self,
        ...
        *,
        ...
        """ create an IDF instance with a specified version and validity-checking setting
    ...
    def _clean_idftext(text:str) -> str:
        """Clean IDF text to parse objects, fields, etc.
        * remove comments
        * remove unnecessary blanks
    ...
    def read_idf(cls,
        ...
        *,
        ...
        ----
            ...
            verbose         (bool): show progress while parsing IDF objects if True. Default to False
        ...
        # make IDF object texts a tqdm instance if verbose
        if verbose:
    ...
    def write(self, filepath:str|None=None) -> None:
        ...
        Args
        ----
            filepath (str): file path to save the IDF. The '.idf' extension is recommended
        """
    ...
    def __str__(self) -> str:
        """Return the concatenated IDF text for all objects
        """
