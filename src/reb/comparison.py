        ...
        for _, row in before["실"].iterrows():
            ...
            if pd.isna(row["난방 공급 설비"]):
                ...
                match beforesupply["유형"]:
                    ...
                    case "팬코일유닛":
                        beforeheating = f"팬코일유닛&{beforesource["유형"]}: 효율 {beforesource["효율 [%]"]:.1f}%, {beforesource["난방용량 [W]"]*1E-3:.2f}kW"
                    case "방열기"   :
                        beforeheating = f"방열기&{beforesource["유형"]}: 효율 {beforesource["효율 [%]"]:.1f}%, {beforesource["난방용량 [W]"]*1E-3:.2f}kW"
                    case "전기방열기":
            ...
            if pd.isna(afterrow["난방 공급 설비"]):
                ...
                match aftersupply["유형"]:
                    ...
                    case "팬코일유닛":
                        afterheating = f"팬코일유닛&{aftersource["유형"]}: 효율 {aftersource["효율 [%]"]:.1f}%, {aftersource["난방용량 [W]"]*1E-3:.2f}kW"
                    case "방열기"   :
                        afterheating = f"방열기&{aftersource["유형"]}: 효율 {aftersource["효율 [%]"]:.1f}%, {aftersource["난방용량 [W]"]*1E-3:.2f}kW"
                    case "전기방열기":
        ...
        for _, row in before["실"].iterrows():
            ...
            if pd.isna(row["냉방 공급 설비"]):
                ...
                match beforesupply["유형"]:
                    ...
                    case "팬코일유닛":
                        beforecooling = f"팬코일유닛&{beforesource["유형"]}: COP {beforesource["냉방COP [W/W]"]:.2f}, {beforesource["냉방용량 [W]"]*1E-3:.2f}kW"
            ...
            if pd.isna(afterrow["냉방 공급 설비"]):
                ...
                match aftersupply["유형"]:
                    ...
                    case "팬코일유닛":
                        aftercooling = f"팬코일유닛&{aftersource["유형"]}: COP {aftersource["냉방COP [W/W]"]:.2f}%, {aftersource["냉방용량 [W]"]*1E-3:.2f}kW"
