...
\texttt{현장조사} 입력은 현장조사 유형에 따라 해석된다. \releaseversion @여기 \는 \texttt{어린이집}과 \texttt{보건소}의 두 유형을 지원하며, 각 유형에 따라 조사되는 변수에 차이가 존재한다. 이에 따라 EnergyPlus 프로필로의 변환 시 먼저 대상 건물의 현장조사 유형을 판별한 뒤, 해당 유형에 맞는 프로필 정의 체계를 적용한다.
